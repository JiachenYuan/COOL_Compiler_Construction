...
define dso_local void @planetpv(ptr noundef %0, i32 noundef %1, ptr noundef %2) #0 {
  ...
  %188 = getelementptr inbounds [8 x [10 x double]], ptr @kq, i64 0, i64 %187
  %189 = load i32, ptr %9, align 4
  %190 = sext i32 %189 to i64
  %191 = getelementptr inbounds [10 x double], ptr %188, i64 0, i64 %190
  ...
  %199 = getelementptr inbounds [9 x double], ptr %196, i64 0, i64 %198
  %200 = load double, ptr %18, align 8
  %201 = load i32, ptr %5, align 4
  %202 = sext i32 %201 to i64
  %203 = getelementptr inbounds [8 x [9 x double]], ptr @sa, i64 0, i64 %202
  %204 = load i32, ptr %9, align 4
  %205 = sext i32 %204 to i64
  %206 = getelementptr inbounds [9 x double], ptr %203, i64 0, i64 %205
  %207 = load double, ptr %18, align 8
  %208 = load double, ptr %12, align 8
  %209 = load i32, ptr %5, align 4
  %210 = sext i32 %209 to i64
  %211 = getelementptr inbounds [8 x [10 x double]], ptr @cl, i64 0, i64 %210
  %212 = load i32, ptr %9, align 4
  %213 = sext i32 %212 to i64
  %214 = getelementptr inbounds [10 x double], ptr %211, i64 0, i64 %213
  %215 = load double, ptr %19, align 8
  %216 = load i32, ptr %5, align 4
  %217 = sext i32 %216 to i64
  %218 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %217
  %219 = load i32, ptr %9, align 4
  %220 = sext i32 %219 to i64
  %221 = getelementptr inbounds [10 x double], ptr %218, i64 0, i64 %220
...
225:                                              ; preds = %245, %3
  br i1 %178, label %226, label %246

226:                                              ; preds = %225
  %227 = load double, ptr %184, align 8
  %228 = fmul double %227, %185
  store double %228, ptr %18, align 8
  %229 = load double, ptr %191, align 8
  %230 = fmul double %229, %192
  store double %230, ptr %19, align 8
  %231 = load double, ptr %199, align 8
  %232 = call double @cos(double noundef %200) #5
  %233 = load double, ptr %206, align 8
  %234 = call double @sin(double noundef %207) #5
  %235 = fmul double %233, %234
  %236 = call double @llvm.fmuladd.f64(double %231, double %232, double %235)
  %237 = call double @llvm.fmuladd.f64(double %236, double 0x3E7AD7F29ABCAF48, double %193)
  store double %237, ptr %11, align 8
  %238 = load double, ptr %214, align 8
  %239 = call double @cos(double noundef %215) #5
  %240 = load double, ptr %221, align 8
  %241 = call double @sin(double noundef %222) #5
  %242 = fmul double %240, %241
  %243 = call double @llvm.fmuladd.f64(double %238, double %239, double %242)
  %244 = call double @llvm.fmuladd.f64(double %243, double 0x3E7AD7F29ABCAF48, double %208)
  store double %244, ptr %12, align 8
  br label %245
...
246:                                              ; preds = %225
  ...
  %282 = load double, ptr %17, align 8
  ...
  %294 = getelementptr inbounds [8 x [10 x double]], ptr @sl, i64 0, i64 %293
  %295 = load i32, ptr %9, align 4
  %296 = sext i32 %295 to i64
  %297 = getelementptr inbounds [10 x double], ptr %294, i64 0, i64 %296
  %298 = load double, ptr %19, align 8
  %299 = load i32, ptr %9, align 4
  %300 = add nsw i32 %299, 1
  br label %301

301:                                              ; preds = %313, %246
  br i1 %275, label %302, label %314

302:                                              ; preds = %301
  %303 = load double, ptr %281, align 8
  %304 = fmul double %303, %282
  store double %304, ptr %19, align 8
  %305 = load double, ptr %290, align 8
  %306 = call double @cos(double noundef %291) #5
  %307 = load double, ptr %297, align 8
  %308 = call double @sin(double noundef %298) #5
  %309 = fmul double %307, %308
  %310 = call double @llvm.fmuladd.f64(double %305, double %306, double %309)
  %311 = fmul double %284, %310
  %312 = call double @llvm.fmuladd.f64(double %311, double 0x3E7AD7F29ABCAF48, double %283)
...
341:                                              ; preds = %351, %314
  %342 = call double @sin(double noundef %329) #5
  %343 = call double @llvm.fmuladd.f64(double %328, double %342, double %327)
  %344 = call double @cos(double noundef %331) #5
  %345 = call double @llvm.fmuladd.f64(double %332, double %344, double 1.000000e+00)
  %346 = fdiv double %343, %345
  store double %346, ptr %22, align 8
  store double %335, ptr %21, align 8
  store i32 %337, ptr %9, align 4
  br i1 %339, label %350, label %347

347:                                              ; preds = %341
  %348 = call double @llvm.fabs.f64(double %340)
...
24:                                               ; preds = %23
  ...
  %26 = call i32 @strcmp(ptr noundef %25, ptr noundef @.str) #6
  %27 = icmp ne i32 %26, 0
...
32:                                               ; preds = %31, %2
  ...
  %44 = getelementptr inbounds [2 x double], ptr %9, i64 0, i64 0
  %45 = load i32, ptr %8, align 4
  %46 = getelementptr inbounds [2 x [3 x double]], ptr %10, i64 0, i64 0
  %47 = getelementptr inbounds [2 x [3 x double]], ptr %10, i64 0, i64 0
...
59:                                               ; preds = %58
  store double 0x4142B42C80000000, ptr %35, align 16
...
63:                                               ; preds = %62
  call void @planetpv(ptr noundef %44, i32 noundef %45, ptr noundef %46)
  call void @radecdist(ptr noundef %47, ptr noundef %51)
  br label %64
...
69:                                               ; preds = %58
  ...
  %78 = getelementptr inbounds [8 x [3 x double]], ptr %11, i64 0, i64 %77
  %79 = getelementptr inbounds [3 x double], ptr %78, i64 0, i64 1
  %80 = load i32, ptr %8, align 4
  %81 = sext i32 %80 to i64
  %82 = getelementptr inbounds [8 x [3 x double]], ptr %11, i64 0, i64 %81
  %83 = getelementptr inbounds [3 x double], ptr %82, i64 0, i64 2
...
87:                                               ; preds = %86
  ...
  %91 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %88, double noundef %89, double noundef %90)
  br label %92
