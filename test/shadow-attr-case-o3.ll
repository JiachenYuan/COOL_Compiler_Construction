; ModuleID = 'shadow-attr-case.ll'
source_filename = "shadow-attr-case.ll"
...
@String.0 = local_unnamed_addr constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @global_str.0, i32 0, i32 0) }
...
entry:
  %vtpm.26.i = tail call i8* @malloc(i32 16)
  %malloc.null.i = icmp eq i8* %vtpm.26.i, null
...
Main_main.exit:                                   ; preds = %entry
  %vtpm.27.i = bitcast i8* %vtpm.26.i to %Main*
  %vtpm.28.i = bitcast i8* %vtpm.26.i to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.28.i, align 8
  %vtpm.29.i = getelementptr i8, i8* %vtpm.26.i, i64 8
  %0 = bitcast i8* %vtpm.29.i to %String**
  store %String* @String.1, %String** %0, align 8
  %1 = bitcast i8* %vtpm.26.i to %IO*
  %vtpm.14.i = tail call %IO* @IO_out_string(%IO* nonnull %1, %String* nonnull @String.2)
  %vtpm.18.i = load %_Main_vtable*, %_Main_vtable** %vtpm.28.i, align 8
  %vtpm.19.i = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.18.i, i64 0, i32 7
  %tmp.4.i = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.19.i, align 8
  %vtpm.20.i = tail call %Main* %tmp.4.i(%Main* nonnull %vtpm.27.i, %String* nonnull @String.3)
  ret i32 0
}
...
ok.1:                                             ; preds = %entry
  ...
  %tmp.2 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.13, align 8
  %vtpm.14 = tail call %Main* %tmp.2(%Main* nonnull %self, %String* nonnull @String.2)
  ...
  %tmp.4 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.19, align 8
  %vtpm.20 = tail call %Main* %tmp.4(%Main* nonnull %self, %String* nonnull @String.3)
...
entry:
  %vtpm.26 = tail call i8* @malloc(i32 16)
  %malloc.null = icmp eq i8* %vtpm.26, null
  br i1 %malloc.null, label %abort, label %okay

okay:                                             ; preds = %entry
  %vtpm.27 = bitcast i8* %vtpm.26 to %Main*
  %vtpm.28 = bitcast i8* %vtpm.26 to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.28, align 8
  %vtpm.29 = getelementptr i8, i8* %vtpm.26, i64 8
  %0 = bitcast i8* %vtpm.29 to %String**
  store %String* @String.1, %String** %0, align 8
  ret %Main* %vtpm.27
