...
@global_str.0 = internal constant [10 x i8] c"attr1o.cl\00"
...
entry:
  %vtpm.16.i = tail call i8* @malloc(i32 16)
  %malloc.null.i = icmp eq i8* %vtpm.16.i, null
...
Main_main.exit:                                   ; preds = %entry
  %vtpm.18.i = bitcast i8* %vtpm.16.i to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.18.i, align 8
  %vtpm.19.i = getelementptr i8, i8* %vtpm.16.i, i64 8
  %0 = bitcast i8* %vtpm.19.i to i32*
  store i32 247, i32* %0, align 4
  %1 = bitcast i8* %vtpm.16.i to %IO*
  %vtpm.9.i = tail call %IO* @IO_out_int(%IO* nonnull %1, i32 247)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.11 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.11
...
entry:
  %vtpm.16 = tail call i8* @malloc(i32 16)
  %malloc.null = icmp eq i8* %vtpm.16, null
  br i1 %malloc.null, label %abort, label %okay

okay:                                             ; preds = %entry
  %vtpm.17 = bitcast i8* %vtpm.16 to %Main*
  %vtpm.18 = bitcast i8* %vtpm.16 to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.18, align 8
  %vtpm.19 = getelementptr i8, i8* %vtpm.16, i64 8
  %0 = bitcast i8* %vtpm.19 to i32*
  store i32 247, i32* %0, align 4
  ret %Main* %vtpm.17
