...
@global_str.0 = internal constant [12 x i8] c"typcase1.cl\00"
...
entry:
	...
	%tmp.1 = icmp eq %Main* %vtpm.2, null
	br i1 %tmp.1, label %abort, label %ok.0

ok.0:
	%vtpm.3 = getelementptr %Main, %Main* %vtpm.2, i32 0, i32 0
	%vtpm.4 = load %_Main_vtable*, %_Main_vtable** %vtpm.3
	%vtpm.5 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.4, i32 0, i32 0
...
case.0.0:
	%vtpm.7 = icmp slt i32 %vtpm.6, 0
	br i1 %vtpm.7, label %br_exit.0.0, label %src_gte_br.0.0

src_gte_br.0.0:
	%vtpm.8 = icmp sgt i32 %vtpm.6, 5
	br i1 %vtpm.8, label %br_exit.0.0, label %src_lte_mc.0.0

src_lte_mc.0.0:
	%vtpm.9 = bitcast %Main* %vtpm.2 to %Object*
	store %Object* %vtpm.9, %Object** %vtpm.0
	%vtpm.10 = load %Object*, %Object** %vtpm.0
	store %Object* %vtpm.10, %Object** %tmp.0
...
case.exit.0:
	%tmp.2 = load %Object*, %Object** %tmp.0
	ret %Object* %tmp.2
