...
ok.0:
	...
	%vtpm.7 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.6, i32 0, i32 8
	%tmp.0 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.7
	%vtpm.8 = call %Main*(%Main*, i32 ) %tmp.0( %Main* %vtpm.3, i32 %vtpm.2 )
