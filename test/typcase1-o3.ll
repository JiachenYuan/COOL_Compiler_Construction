; ModuleID = 'typcase1.ll'
source_filename = "typcase1.ll"
...
define %Object* @Main_main(%Main* readonly %self) {
entry:
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.5 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.4, i64 0, i32 0
  %vtpm.6 = load i32, i32* %vtpm.5, align 4
  %0 = icmp ugt i32 %vtpm.6, 5
  br i1 %0, label %abort, label %src_lte_mc.0.0

src_lte_mc.0.0:                                   ; preds = %ok.0
  %vtpm.9 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.9
