...
ok.0:
	%vtpm.21 = getelementptr %_Foo_vtable, %_Foo_vtable* @_Foo_vtable_prototype, i32 0, i32 7
	%tmp.0 = load %Object* (%Foo*) *, %Object* (%Foo*) ** %vtpm.21
	%vtpm.22 = call %Object*(%Foo* ) %tmp.0( %Foo* %vtpm.19 )
	ret %Object* %vtpm.22
...
okay:
	...
	%vtpm.30 = getelementptr %Main, %Main* %vtpm.28, i32 0, i32 1
	store %Foo* null, %Foo** %vtpm.30
	%vtpm.31 = getelementptr %Main, %Main* %vtpm.28, i32 0, i32 1
