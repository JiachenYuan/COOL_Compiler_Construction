; ModuleID = 'divide_o.ll'
source_filename = "divide_o.ll"
...
@global_str.0 = internal constant [12 x i8] c"divide_o.cl\00"
...
Main_main.exit:                                   ; preds = %entry
  ...
  %0 = bitcast i8* %vtpm.23.i to %IO*
  %vtpm.16.i = tail call %IO* @IO_out_int(%IO* nonnull %0, i32 2)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %tmp.0 = load i32 (%Main*)*, i32 (%Main*)** %vtpm.9, align 8
  %vtpm.10 = tail call i32 %tmp.0(%Main* nonnull %self)
  ...
  %vtpm.16 = tail call %Main* %tmp.1(%Main* nonnull %self, i32 %vtpm.10)
  %vtpm.18 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.18
