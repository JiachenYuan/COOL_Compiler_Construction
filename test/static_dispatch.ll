...
declare %String* @Main_test1(%Main*, i1, %String*, i32)
...
@_Main_vtable_prototype = constant %_Main_vtable {
	...
	%String* (%Main*,i1,%String*,i32) * @Main_test1,
...
define %String* @Main_test1(%Main* %self, i1 %arg1, %String* %arg2, i32 %arg3) {
