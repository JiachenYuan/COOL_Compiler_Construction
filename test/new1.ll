...
entry:
	...
	%malloc.null = icmp eq %Main* %vtpm.12, null
	br i1 %malloc.null, label %abort, label %okay

okay:
	%vtpm.13 = getelementptr %Main, %Main* %vtpm.12, i32 0, i32 0
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.13
	store %Main* %vtpm.12, %Main** %vtpm.8
	%vtpm.14 = getelementptr %Main, %Main* %vtpm.12, i32 0, i32 1
	store i32 0, i32* %vtpm.14
	%vtpm.15 = getelementptr %Main, %Main* %vtpm.12, i32 0, i32 1
	%vtpm.16 = call %Int* @Int_new(  )
	%vtpm.17 = load %Main*, %Main** %vtpm.8
