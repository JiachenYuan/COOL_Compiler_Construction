; ModuleID = 'equal2_o.ll'
source_filename = "equal2_o.ll"
...
@global_str.3 = internal constant [9 x i8] c"not ok!\0A\00"
@String.3 = local_unnamed_addr constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @global_str.3, i32 0, i32 0) }
...
@global_str.1 = internal constant [3 x i8] c"s1\00"
@String.1 = local_unnamed_addr constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @global_str.1, i32 0, i32 0) }
@global_str.0 = internal constant [12 x i8] c"equal2_o.cl\00"
...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.10.i = tail call %IO* @IO_out_string(%IO* nonnull %0, %String* nonnull @String.2)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.9 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.8, i64 0, i32 7
  %tmp.0 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.9, align 8
  %vtpm.10 = tail call %Main* %tmp.0(%Main* nonnull %self, %String* nonnull @String.2)
  ret %Main* %vtpm.10
