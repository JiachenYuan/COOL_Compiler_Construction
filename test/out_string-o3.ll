; ModuleID = 'out_string.ll'
source_filename = "out_string.ll"
...
@global_str.1 = internal constant [7 x i8] c"Hello\0A\00"
...
@global_str.0 = internal constant [14 x i8] c"out_string.cl\00"
...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.6.i = tail call %IO* @IO_out_string(%IO* nonnull %0, %String* nonnull @String.1)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.5 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.4, i64 0, i32 7
  %tmp.0 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.5, align 8
  %vtpm.6 = tail call %Main* %tmp.0(%Main* nonnull %self, %String* nonnull @String.1)
