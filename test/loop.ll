...
@global_str.0 = internal constant [8 x i8] c"loop.cl\00"
...
while.0:
	...
	%vtpm.4 = icmp slt i32 0, %vtpm.3
	br i1 %vtpm.4, label %loop_body.0, label %loop_end.0

loop_body.0:
	%vtpm.5 = load i32, i32* %vtpm.1
	%vtpm.6 = sub i32 %vtpm.5, 1
	store i32 %vtpm.6, i32* %vtpm.1
	br label %while.0
