...
entry:
	...
	store i32 20, i32* %vtpm.1
	%vtpm.4 = load i32, i32* %vtpm.1
	%vtpm.5 = add i32 %vtpm.4, 2
	store i32 %vtpm.5, i32* %vtpm.2
	%vtpm.6 = load i32, i32* %vtpm.0
	%vtpm.7 = load i32, i32* %vtpm.2
	%vtpm.8 = add i32 %vtpm.6, %vtpm.7
	%vtpm.9 = load %Main*, %Main** %vtpm.3
...
ok.0:
	...
	%tmp.0 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.13
	%vtpm.14 = call %Main*(%Main*, i32 ) %tmp.0( %Main* %vtpm.9, i32 %vtpm.8 )
