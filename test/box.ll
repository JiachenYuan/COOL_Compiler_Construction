...
@String.0 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([7 x i8], [7 x i8]* @global_str.0, i32 0, i32 0)
}
...
ok.0:
	%vtpm.7 = getelementptr %Int, %Int* %vtpm.4, i32 0, i32 0
	%vtpm.8 = load %_Int_vtable*, %_Int_vtable** %vtpm.7
	%vtpm.9 = getelementptr %_Int_vtable, %_Int_vtable* %vtpm.8, i32 0, i32 6
	%tmp.0 = load %Int* (%Int*) *, %Int* (%Int*) ** %vtpm.9
	%vtpm.10 = call %Int*(%Int* ) %tmp.0( %Int* %vtpm.4 )
	%vtpm.11 = getelementptr %Int, %Int* %vtpm.10, i32 0, i32 1
	%vtpm.12 = load i32, i32* %vtpm.11
	store i32 %vtpm.12, i32* %vtpm.1
	%vtpm.13 = load i32, i32* %vtpm.1
	%vtpm.14 = load %Main*, %Main** %vtpm.2
