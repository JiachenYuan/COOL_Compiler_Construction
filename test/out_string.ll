...
ok.0:
	...
	%vtpm.5 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.4, i32 0, i32 7
	%tmp.0 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.5
	%vtpm.6 = call %Main*(%Main*, %String* ) %tmp.0( %Main* %vtpm.1, %String* @String.1 )
	%vtpm.7 = load %Main*, %Main** %vtpm.0
	%vtpm.8 = bitcast %Main* %vtpm.7 to %Object*
	ret %Object* %vtpm.8
...
entry:
	...
	%malloc.null = icmp eq %Main* %vtpm.14, null
	br i1 %malloc.null, label %abort, label %okay

okay:
	%vtpm.15 = getelementptr %Main, %Main* %vtpm.14, i32 0, i32 0
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.15
	store %Main* %vtpm.14, %Main** %vtpm.10
	ret %Main* %vtpm.14
