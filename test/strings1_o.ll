...
@global_str.0 = internal constant [14 x i8] c"strings1_o.cl\00"
...
ok.0:
	...
	%vtpm.7 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.6, i32 0, i32 11
	%tmp.0 = load %String* (%Main*) *, %String* (%Main*) ** %vtpm.7
	%vtpm.8 = call %String*(%Main* ) %tmp.0( %Main* %vtpm.3 )
	%vtpm.9 = load %Main*, %Main** %vtpm.2
...
ok.1:
	...
	%vtpm.14 = call %Main*(%Main*, %String* ) %tmp.1( %Main* %vtpm.9, %String* %vtpm.8 )
	%vtpm.15 = load %Main*, %Main** %vtpm.2
