; ModuleID = 'letinittrap_o.ll'
source_filename = "letinittrap_o.ll"
...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.11.i = tail call %IO* @IO_out_int(%IO* nonnull %0, i32 1)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.11 = tail call %Main* %tmp.0(%Main* nonnull %self, i32 1)
