...
@global_str.0 = internal constant [9 x i8] c"neg_o.cl\00"
@String.0 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([9 x i8], [9 x i8]* @global_str.0, i32 0, i32 0)
}
...
ok.0:
	...
	%tmp.0 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.14
	%vtpm.15 = call %Main*(%Main*, i32 ) %tmp.0( %Main* %vtpm.10, i32 %vtpm.9 )
...
okay:
	...
	%vtpm.25 = getelementptr %Main, %Main* %vtpm.23, i32 0, i32 1
	store i32 0, i32* %vtpm.25
	%vtpm.26 = getelementptr %Main, %Main* %vtpm.23, i32 0, i32 1
	%vtpm.27 = load %Main*, %Main** %vtpm.19
	%vtpm.28 = getelementptr %Main, %Main* %vtpm.27, i32 0, i32 1
	store i32 10, i32* %vtpm.28
	ret %Main* %vtpm.23
