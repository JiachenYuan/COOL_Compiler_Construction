...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.20.i = load %_Main_vtable*, %_Main_vtable** %vtpm.38.i, align 8
  ...
  %vtpm.28.i = tail call %Main* %tmp.1.i(%Main* nonnull %vtpm.37.i, %String* nonnull %String.1.String.2.i)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.31 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.31
