...
op_type op_type::get_deref_type() {
  ...
  case OBJ_PPTR:
    ...
    break;
  default:
    std::cerr << ">> The name of the op_type I try to dereference is " << name << std::endl;
...
op_func_type::op_func_type(const op_func_type& other) {
  name = other.name;
  res = other.res;
  args = other.args;
  id = other.id;
...
op_func_ptr_type::op_func_ptr_type(const op_func_ptr_type& other) {
  name = other.name;
  res = other.res;
  args = other.args;
  id = other.id;
