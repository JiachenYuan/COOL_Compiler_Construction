...
entry:
	...
	%vtpm.2 = load %String*, %String** %vtpm.0
	%vtpm.3 = load %Main*, %Main** %vtpm.1
	%vtpm.4 = icmp eq %Main* %vtpm.3, null
	br i1 %vtpm.4, label %abort, label %ok.0

ok.0:
	%vtpm.5 = getelementptr %Main, %Main* %vtpm.3, i32 0, i32 0
	%vtpm.6 = load %_Main_vtable*, %_Main_vtable** %vtpm.5
	%vtpm.7 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.6, i32 0, i32 7
	%tmp.0 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.7
	%vtpm.8 = call %Main*(%Main*, %String* ) %tmp.0( %Main* %vtpm.3, %String* %vtpm.2 )
...
ok.1:
	...
	%tmp.1 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.13
	%vtpm.14 = call %Main*(%Main*, %String* ) %tmp.1( %Main* %vtpm.9, %String* @String.3 )
...
okay:
	...
	store %String* null, %String** %vtpm.23
	%vtpm.24 = getelementptr %Main, %Main* %vtpm.21, i32 0, i32 1
	%vtpm.25 = load %Main*, %Main** %vtpm.17
	%vtpm.26 = getelementptr %Main, %Main* %vtpm.25, i32 0, i32 1
	store %String* @String.1, %String** %vtpm.26
	ret %Main* %vtpm.21
