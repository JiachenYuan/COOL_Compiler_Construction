; ModuleID = 'shadow-let-let.ll'
source_filename = "shadow-let-let.ll"
...
@global_str.0 = internal constant [18 x i8] c"shadow-let-let.cl\00"
@String.0 = local_unnamed_addr constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_str.0, i32 0, i32 0) }
...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.9.i = tail call %IO* @IO_out_string(%IO* nonnull %0, %String* nonnull @String.2)
  %vtpm.13.i = load %_Main_vtable*, %_Main_vtable** %vtpm.23.i, align 8
  %vtpm.14.i = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.13.i, i64 0, i32 7
  %tmp.1.i = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.14.i, align 8
  %vtpm.15.i = tail call %Main* %tmp.1.i(%Main* nonnull %vtpm.22.i, %String* nonnull @String.3)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.8 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.7, i64 0, i32 7
  %tmp.0 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.8, align 8
  %vtpm.9 = tail call %Main* %tmp.0(%Main* nonnull %self, %String* nonnull @String.2)
  %vtpm.13 = load %_Main_vtable*, %_Main_vtable** %vtpm.6, align 8
  %vtpm.14 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.13, i64 0, i32 7
  %tmp.1 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.14, align 8
  %vtpm.15 = tail call %Main* %tmp.1(%Main* nonnull %self, %String* nonnull @String.3)
  %vtpm.16 = bitcast %Main* %vtpm.15 to %Object*
  ret %Object* %vtpm.16
