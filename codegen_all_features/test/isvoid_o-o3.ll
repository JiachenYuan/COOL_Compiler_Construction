...
@String.2 = constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @global_str.2, i32 0, i32 0) }
@global_str.1 = internal constant [3 x i8] c"ok\00"
@String.1 = constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @global_str.1, i32 0, i32 0) }
...
entry:
  %vtpm.33.i = tail call i8* @malloc(i32 16)
...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.36.i = getelementptr i8, i8* %vtpm.33.i, i64 8
  %0 = bitcast i8* %vtpm.36.i to %Main**
  store %Main* null, %Main** %0, align 8
  %1 = bitcast i8* %vtpm.33.i to %IO*
  %vtpm.25.i = tail call %IO* @IO_out_string(%IO* nonnull %1, %String* nonnull @String.1)
  ret i32 0
}
...
define i1 @Main_func(%Main* nocapture readonly %self) #0 {
entry:
...
ok.0:                                             ; preds = %entry
  ...
  %tmp.0 = load i1 (%Main*)*, i1 (%Main*)** %vtpm.12, align 8
  %vtpm.13 = tail call i1 %tmp.0(%Main* nonnull %self)
  %vtpm.17 = load %_Main_vtable*, %_Main_vtable** %vtpm.10, align 8
  %vtpm.18 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.17, i64 0, i32 7
  %tmp.1 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.18, align 8
  %String.1.String.2 = select i1 %vtpm.13, %String* @String.1, %String* @String.2
  %vtpm.25 = tail call %Main* %tmp.1(%Main* nonnull %self, %String* nonnull %String.1.String.2)
  %vtpm.28 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.28
...
entry:
  %vtpm.33 = tail call i8* @malloc(i32 16)
...
okay:                                             ; preds = %entry
  ...
  %vtpm.36 = getelementptr i8, i8* %vtpm.33, i64 8
  %0 = bitcast i8* %vtpm.36 to %Main**
  store %Main* null, %Main** %0, align 8
  ret %Main* %vtpm.34
