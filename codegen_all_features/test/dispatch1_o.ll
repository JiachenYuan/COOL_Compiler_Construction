...
ok.0:
	...
	%tmp.0 = load i32 (%Main*) *, i32 (%Main*) ** %vtpm.5
	%vtpm.6 = call i32(%Main* ) %tmp.0( %Main* %vtpm.1 )
...
ok.1:
	...
	%vtpm.11 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.10, i32 0, i32 8
	%tmp.1 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.11
	%vtpm.12 = call %Main*(%Main*, i32 ) %tmp.1( %Main* %vtpm.7, i32 %vtpm.6 )
...
define i32 @Main_niam(%Main* %self) {
