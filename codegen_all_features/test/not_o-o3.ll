...
@global_str.0 = internal constant [9 x i8] c"not_o.cl\00"
@String.0 = local_unnamed_addr constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @global_str.0, i32 0, i32 0) }
...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.22.i = tail call %IO* @IO_out_int(%IO* nonnull %0, i32 1)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.15 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.14, i64 0, i32 8
  %tmp.1 = load %Main* (%Main*, i32)*, %Main* (%Main*, i32)** %vtpm.15, align 8
  %. = zext i1 %vtpm.10 to i32
  %vtpm.22 = tail call %Main* %tmp.1(%Main* nonnull %self, i32 %.)
  %vtpm.25 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.25
