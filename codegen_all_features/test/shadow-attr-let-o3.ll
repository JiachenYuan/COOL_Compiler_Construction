; ModuleID = 'shadow-attr-let.ll'
source_filename = "shadow-attr-let.ll"
...
@global_str.0 = internal constant [19 x i8] c"shadow-attr-let.cl\00"
...
entry:
  %vtpm.20.i = tail call i8* @malloc(i32 16)
  %malloc.null.i = icmp eq i8* %vtpm.20.i, null
...
Main_main.exit:                                   ; preds = %entry
  %vtpm.21.i = bitcast i8* %vtpm.20.i to %Main*
  %vtpm.22.i = bitcast i8* %vtpm.20.i to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.22.i, align 8
  %vtpm.23.i = getelementptr i8, i8* %vtpm.20.i, i64 8
  %0 = bitcast i8* %vtpm.23.i to %String**
  store %String* @String.1, %String** %0, align 8
  %1 = bitcast i8* %vtpm.20.i to %IO*
  %vtpm.8.i = tail call %IO* @IO_out_string(%IO* nonnull %1, %String* nonnull @String.2)
  %vtpm.12.i = load %_Main_vtable*, %_Main_vtable** %vtpm.22.i, align 8
  %vtpm.13.i = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.12.i, i64 0, i32 7
  %tmp.1.i = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.13.i, align 8
  %vtpm.14.i = tail call %Main* %tmp.1.i(%Main* nonnull %vtpm.21.i, %String* nonnull @String.3)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.7 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.6, i64 0, i32 7
  %tmp.0 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.7, align 8
  %vtpm.8 = tail call %Main* %tmp.0(%Main* nonnull %self, %String* nonnull @String.2)
  ...
  %vtpm.14 = tail call %Main* %tmp.1(%Main* nonnull %self, %String* nonnull @String.3)
  %vtpm.15 = bitcast %Main* %vtpm.14 to %Object*
  ret %Object* %vtpm.15
...
entry:
  %vtpm.20 = tail call i8* @malloc(i32 16)
  %malloc.null = icmp eq i8* %vtpm.20, null
  br i1 %malloc.null, label %abort, label %okay

okay:                                             ; preds = %entry
  %vtpm.21 = bitcast i8* %vtpm.20 to %Main*
  %vtpm.22 = bitcast i8* %vtpm.20 to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.22, align 8
  %vtpm.23 = getelementptr i8, i8* %vtpm.20, i64 8
  %0 = bitcast i8* %vtpm.23 to %String**
  store %String* @String.1, %String** %0, align 8
  ret %Main* %vtpm.21
