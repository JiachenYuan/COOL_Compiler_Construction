; ModuleID = 'shadow-formal-case.ll'
source_filename = "shadow-formal-case.ll"
...
Main_method.exit:                                 ; preds = %entry
  %vtpm.37.i = bitcast i8* %vtpm.36.i to %Main*
  %vtpm.38.i = bitcast i8* %vtpm.36.i to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.38.i, align 8
  %0 = bitcast i8* %vtpm.36.i to %IO*
  %vtpm.30.i = tail call %IO* @IO_out_string(%IO* nonnull %0, %String* nonnull @String.1)
  %vtpm.10.i = load %_Main_vtable*, %_Main_vtable** %vtpm.38.i, align 8
  ...
  %vtpm.12.i = tail call %Main* %tmp.1.i(%Main* nonnull %vtpm.37.i, %String* nonnull @String.3)
  ret i32 0
}
...
ok.1:                                             ; preds = %entry
  ...
  %vtpm.29 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.28, i64 0, i32 7
  %tmp.2 = load %Main* (%Main*, %String*)*, %Main* (%Main*, %String*)** %vtpm.29, align 8
  %vtpm.30 = tail call %Main* %tmp.2(%Main* nonnull %self, %String* nonnull @String.1)
...
okay:                                             ; preds = %entry
  ...
  %vtpm.38 = bitcast i8* %vtpm.36 to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.38, align 8
  ret %Main* %vtpm.37
