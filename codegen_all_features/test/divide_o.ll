...
entry:
	...
	%vtpm.1 = icmp eq i32 2, 0
	br i1 %vtpm.1, label %abort, label %ok.0
...
ok.0:
	...
	%tmp.0 = load i32 (%Main*) *, i32 (%Main*) ** %vtpm.9
	%vtpm.10 = call i32(%Main* ) %tmp.0( %Main* %vtpm.5 )
...
ok.1:
	...
	%vtpm.16 = call %Main*(%Main*, i32 ) %tmp.1( %Main* %vtpm.11, i32 %vtpm.10 )
