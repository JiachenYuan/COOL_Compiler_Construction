; ModuleID = 'nestedlet_o.ll'
source_filename = "nestedlet_o.ll"
...
@global_str.0 = internal constant [15 x i8] c"nestedlet_o.cl\00"
...
entry:
  %vtpm.20.i = tail call i8* @malloc(i32 8)
...
Main_main.exit:                                   ; preds = %entry
  ...
  %0 = bitcast i8* %vtpm.20.i to %IO*
  %vtpm.14.i = tail call %IO* @IO_out_int(%IO* nonnull %0, i32 32)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %tmp.0 = load %Main* (%Main*, i32)*, %Main* (%Main*, i32)** %vtpm.13, align 8
  %vtpm.14 = tail call %Main* %tmp.0(%Main* nonnull %self, i32 32)
...
entry:
  %vtpm.20 = tail call i8* @malloc(i32 8)
