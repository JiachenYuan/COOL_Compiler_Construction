...
@global_str.0 = internal constant [10 x i8] c"let2_o.cl\00"
...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.28.i = tail call %IO* @IO_out_int(%IO* nonnull %0, i32 1)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.21 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.20, i64 0, i32 8
  %tmp.1 = load %Main* (%Main*, i32)*, %Main* (%Main*, i32)** %vtpm.21, align 8
  %. = zext i1 %vtpm.16 to i32
  %vtpm.28 = tail call %Main* %tmp.1(%Main* nonnull %self, i32 %.)
