; ModuleID = 'assign2o.ll'
source_filename = "assign2o.ll"
...
Main_new.exit:                                    ; preds = %entry
  ...
  %0 = bitcast i8* %vtpm.24.i to i32*
  store i32 878, i32* %0, align 4
  %1 = bitcast i8* %vtpm.21.i to %IO*
  %vtpm.14.i = tail call %IO* @IO_out_int(%IO* nonnull %1, i32 878)
  ret i32 0
}
...
ok.0:
  ...
  store i32 878, i32* %vtpm.2, align 4
  ...
  %vtpm.14 = tail call %Main* %tmp.0(%Main* nonnull %self, i32 878)
