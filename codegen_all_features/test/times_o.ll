...
@global_str.0 = internal constant [11 x i8] c"times_o.cl\00"
...
ok.0:
	...
	%vtpm.8 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.7, i32 0, i32 11
	%tmp.0 = load i32 (%Main*) *, i32 (%Main*) ** %vtpm.8
	%vtpm.9 = call i32(%Main* ) %tmp.0( %Main* %vtpm.4 )
	%vtpm.10 = load %Main*, %Main** %vtpm.3
...
ok.1:
	...
	%tmp.1 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.14
	%vtpm.15 = call %Main*(%Main*, i32 ) %tmp.1( %Main* %vtpm.10, i32 %vtpm.9 )
