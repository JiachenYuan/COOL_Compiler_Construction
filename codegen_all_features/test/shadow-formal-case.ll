...
@_Main_vtable_prototype = constant %_Main_vtable {
	...
	%Object* (%Main*,%String*) * @Main_method,
...
@String.2 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([4 x i8], [4 x i8]* @global_str.2, i32 0, i32 0)
}
...
@global_str.0 = internal constant [22 x i8] c"shadow-formal-case.cl\00"
@String.0 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([22 x i8], [22 x i8]* @global_str.0, i32 0, i32 0)
}
...
ok.0:
	...
	%vtpm.5 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.4, i32 0, i32 11
	%tmp.0 = load %Object* (%Main*,%String*) *, %Object* (%Main*,%String*) ** %vtpm.5
	%vtpm.6 = call %Object*(%Main*, %String* ) %tmp.0( %Main* %vtpm.1, %String* @String.2 )
...
ok.1:
	...
	%vtpm.12 = call %Main*(%Main*, %String* ) %tmp.1( %Main* %vtpm.7, %String* @String.3 )
...
entry:
	%tmp.0 = alloca %Main*
	%vtpm.15 = alloca %String*
	%vtpm.16 = alloca %Main*
	%vtpm.17 = alloca %String*
	store %Main* %self, %Main** %vtpm.16
	store %String* %var, %String** %vtpm.17
	%tmp.1 = icmp eq %String* @String.1, null
	br i1 %tmp.1, label %abort, label %ok.0

ok.0:
	%vtpm.18 = getelementptr %String, %String* @String.1, i32 0, i32 0
	%vtpm.19 = load %_String_vtable*, %_String_vtable** %vtpm.18
	%vtpm.20 = getelementptr %_String_vtable, %_String_vtable* %vtpm.19, i32 0, i32 0
...
case.3.0:
	%vtpm.22 = icmp slt i32 %vtpm.21, 3
	br i1 %vtpm.22, label %br_exit.3.0, label %src_gte_br.3.0

src_gte_br.3.0:
	%vtpm.23 = icmp sgt i32 %vtpm.21, 3
	br i1 %vtpm.23, label %br_exit.3.0, label %src_lte_mc.3.0

src_lte_mc.3.0:
	store %String* @String.1, %String** %vtpm.15
	%vtpm.24 = load %String*, %String** %vtpm.15
	%vtpm.25 = load %Main*, %Main** %vtpm.16
...
ok.1:
	...
	%vtpm.29 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.28, i32 0, i32 7
	%tmp.2 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.29
	%vtpm.30 = call %Main*(%Main*, %String* ) %tmp.2( %Main* %vtpm.25, %String* %vtpm.24 )
	store %Main* %vtpm.30, %Main** %tmp.0
...
case.exit.0:
	...
	%vtpm.31 = bitcast %Main* %tmp.3 to %Object*
	ret %Object* %vtpm.31
