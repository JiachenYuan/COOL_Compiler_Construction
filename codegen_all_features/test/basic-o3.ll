...
@global_str.0 = internal constant [9 x i8] c"basic.cl\00"
...
entry:
  %vtpm.7.i = tail call i8* @malloc(i32 8)
  %malloc.null.i = icmp eq i8* %vtpm.7.i, null
...
Main_new.exit:                                    ; preds = %entry
  %vtpm.9.i = bitcast i8* %vtpm.7.i to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.9.i, align 8
  ret i32 0
}
...
define %Object* @Main_main(%Main* readnone %self) #0 {
entry:
  %vtpm.2 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.2
}

define %Main* @Main_new() {
entry:
  %vtpm.7 = tail call i8* @malloc(i32 8)
  %malloc.null = icmp eq i8* %vtpm.7, null
  br i1 %malloc.null, label %abort, label %okay

okay:                                             ; preds = %entry
  %vtpm.8 = bitcast i8* %vtpm.7 to %Main*
  %vtpm.9 = bitcast i8* %vtpm.7 to %_Main_vtable**
  store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.9, align 8
  ret %Main* %vtpm.8
