...
Main_new.exit:                                    ; preds = %entry
  ...
  %vtpm.25.i = getelementptr i8, i8* %vtpm.22.i, i64 8
  %0 = bitcast i8* %vtpm.25.i to i32*
  store i32 -10, i32* %0, align 4
  %1 = bitcast i8* %vtpm.22.i to %IO*
  %vtpm.15.i = tail call %IO* @IO_out_int(%IO* nonnull %1, i32 -10)
  ret i32 0
}
...
ok.0:
  ...
  store i32 %vtpm.4, i32* %vtpm.2, align 4
  ...
  %tmp.0 = load %Main* (%Main*, i32)*, %Main* (%Main*, i32)** %vtpm.14, align 8
  %vtpm.15 = tail call %Main* %tmp.0(%Main* nonnull %self, i32 %vtpm.4)
...
okay:                                             ; preds = %entry
  ...
  %vtpm.25 = getelementptr i8, i8* %vtpm.22, i64 8
  %0 = bitcast i8* %vtpm.25 to i32*
  store i32 10, i32* %0, align 4
  ret %Main* %vtpm.23
