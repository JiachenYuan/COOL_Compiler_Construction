...
entry:
	...
	%vtpm.18 = load %String*, %String** %vtpm.15
	%vtpm.19 = load %Main*, %Main** %vtpm.16
...
ok.0:
	...
	%tmp.0 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.23
	%vtpm.24 = call %Main*(%Main*, %String* ) %tmp.0( %Main* %vtpm.19, %String* %vtpm.18 )
