...
@global_str.0 = internal constant [11 x i8] c"out_int.cl\00"
...
Main_main.exit:                                   ; preds = %entry
  ...
  %vtpm.6.i = tail call %IO* @IO_out_int(%IO* nonnull %0, i32 0)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.6 = tail call %Main* %tmp.0(%Main* nonnull %self, i32 0)
