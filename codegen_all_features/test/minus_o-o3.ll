...
@global_str.0 = internal constant [11 x i8] c"minus_o.cl\00"
...
Main_main.exit:                                   ; preds = %entry
  ...
  %0 = bitcast i8* %vtpm.23.i to i32*
  %vtpm.24.i = getelementptr i8, i8* %vtpm.20.i, i64 12
  %1 = bitcast i8* %vtpm.24.i to i32*
  store i32 10, i32* %0, align 4
  store i32 30, i32* %1, align 4
  %2 = bitcast i8* %vtpm.20.i to %IO*
  %vtpm.13.i = tail call %IO* @IO_out_int(%IO* nonnull %2, i32 -20)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.5 = getelementptr %Main, %Main* %self, i64 0, i32 2
  %vtpm.6 = load i32, i32* %vtpm.5, align 4
  %vtpm.7 = sub i32 %vtpm.3, %vtpm.6
  %vtpm.10 = getelementptr %Main, %Main* %self, i64 0, i32 0
  %vtpm.11 = load %_Main_vtable*, %_Main_vtable** %vtpm.10, align 8
  %vtpm.12 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.11, i64 0, i32 8
  %tmp.0 = load %Main* (%Main*, i32)*, %Main* (%Main*, i32)** %vtpm.12, align 8
  %vtpm.13 = tail call %Main* %tmp.0(%Main* nonnull %self, i32 %vtpm.7)
  %vtpm.15 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.15
...
okay:                                             ; preds = %entry
  ...
  %0 = bitcast i8* %vtpm.23 to i32*
  %vtpm.24 = getelementptr i8, i8* %vtpm.20, i64 12
  %1 = bitcast i8* %vtpm.24 to i32*
  store i32 10, i32* %0, align 4
  store i32 30, i32* %1, align 4
  ret %Main* %vtpm.21
