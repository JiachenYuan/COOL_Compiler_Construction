...
ok.1:
	...
	%vtpm.15 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.14, i32 0, i32 8
	%tmp.1 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.15
	%vtpm.16 = call %Main*(%Main*, i32 ) %tmp.1( %Main* %vtpm.11, i32 1 )
...
ok.2:
	...
	%tmp.2 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.21
	%vtpm.22 = call %Main*(%Main*, i32 ) %tmp.2( %Main* %vtpm.17, i32 0 )
