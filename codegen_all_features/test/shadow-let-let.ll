...
@String.0 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([18 x i8], [18 x i8]* @global_str.0, i32 0, i32 0)
}
...
entry:
	...
	store %String* @String.1, %String** %vtpm.0
	store %String* @String.2, %String** %vtpm.1
	%vtpm.3 = load %String*, %String** %vtpm.1
	%vtpm.4 = load %Main*, %Main** %vtpm.2
...
ok.0:
	...
	%vtpm.8 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.7, i32 0, i32 7
	%tmp.0 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.8
	%vtpm.9 = call %Main*(%Main*, %String* ) %tmp.0( %Main* %vtpm.4, %String* %vtpm.3 )
	%vtpm.10 = load %Main*, %Main** %vtpm.2
...
ok.1:
	...
	%vtpm.14 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.13, i32 0, i32 7
	%tmp.1 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.14
	%vtpm.15 = call %Main*(%Main*, %String* ) %tmp.1( %Main* %vtpm.10, %String* @String.3 )
