...
entry:
	...
	store i32 798, i32* %vtpm.0
	store i1 true, i1* %vtpm.1
	store i32 5, i32* %vtpm.2
	store i32 100, i32* %vtpm.3
	%vtpm.5 = load i32, i32* %vtpm.2
	%vtpm.6 = load i32, i32* %vtpm.3
	%vtpm.7 = icmp slt i32 %vtpm.5, %vtpm.6
	ret i1 %vtpm.7
...
ok.1:
	...
	%vtpm.21 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.20, i32 0, i32 8
	%tmp.1 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.21
	%vtpm.22 = call %Main*(%Main*, i32 ) %tmp.1( %Main* %vtpm.17, i32 1 )
...
ok.2:
	...
	%tmp.2 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.27
	%vtpm.28 = call %Main*(%Main*, i32 ) %tmp.2( %Main* %vtpm.23, i32 0 )
