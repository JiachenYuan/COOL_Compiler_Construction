...
entry:
	...
	store %String* %var, %String** %vtpm.16
	%vtpm.17 = load %String*, %String** %vtpm.16
	%vtpm.18 = load %Main*, %Main** %vtpm.15
...
ok.0:
	...
	%tmp.0 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.22
	%vtpm.23 = call %Main*(%Main*, %String* ) %tmp.0( %Main* %vtpm.18, %String* %vtpm.17 )
...
okay:
	...
	store %String* null, %String** %vtpm.32
	%vtpm.33 = getelementptr %Main, %Main* %vtpm.30, i32 0, i32 1
	%vtpm.34 = load %Main*, %Main** %vtpm.26
	%vtpm.35 = getelementptr %Main, %Main* %vtpm.34, i32 0, i32 1
	store %String* @String.1, %String** %vtpm.35
	ret %Main* %vtpm.30
