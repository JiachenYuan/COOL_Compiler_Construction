...
@String.1 = local_unnamed_addr constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @global_str.1, i32 0, i32 0) }
@global_str.0 = internal constant [11 x i8] c"block_o.cl\00"
...
Main_main.exit:                                   ; preds = %entry
  ...
  %0 = bitcast i8* %vtpm.13.i to %IO*
  %vtpm.6.i = tail call %IO* @IO_out_int(%IO* nonnull %0, i32 890)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.5 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.4, i64 0, i32 8
  %tmp.0 = load %Main* (%Main*, i32)*, %Main* (%Main*, i32)** %vtpm.5, align 8
  %vtpm.6 = tail call %Main* %tmp.0(%Main* nonnull %self, i32 890)
  %vtpm.8 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.8
