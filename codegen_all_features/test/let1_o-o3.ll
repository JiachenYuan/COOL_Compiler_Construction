...
@global_str.0 = internal constant [10 x i8] c"let1_o.cl\00"
...
entry:
  %vtpm.15.i = tail call i8* @malloc(i32 8)
...
Main_main.exit:                                   ; preds = %entry
  ...
  %0 = bitcast i8* %vtpm.15.i to %IO*
  %vtpm.8.i = tail call %IO* @IO_out_int(%IO* nonnull %0, i32 798)
  ret i32 0
}
...
ok.0:                                             ; preds = %entry
  ...
  %vtpm.7 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.6, i64 0, i32 8
  %tmp.0 = load %Main* (%Main*, i32)*, %Main* (%Main*, i32)** %vtpm.7, align 8
  %vtpm.8 = tail call %Main* %tmp.0(%Main* nonnull %self, i32 798)
  %vtpm.10 = bitcast %Main* %self to %Object*
  ret %Object* %vtpm.10
...
entry:
  %vtpm.15 = tail call i8* @malloc(i32 8)
