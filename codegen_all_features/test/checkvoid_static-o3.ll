; ModuleID = 'checkvoid_static.ll'
source_filename = "checkvoid_static.ll"
...
@global_str.0 = internal constant [20 x i8] c"checkvoid_static.cl\00"
...
entry:
  %vtpm.27.i = tail call i8* @malloc(i32 16)
...
ok.0:                                             ; preds = %entry
  %vtpm.1.i = tail call %IO* @IO_new()
  %vtpm.2.i = icmp eq %IO* %vtpm.1.i, null
  br i1 %vtpm.2.i, label %abort.i, label %Foo_f.exit

abort.i:                                          ; preds = %ok.0
  tail call void @abort()
  unreachable

Foo_f.exit:                                       ; preds = %ok.0
  %vtpm.3.i = getelementptr %IO, %IO* %vtpm.1.i, i64 0, i32 0
  %vtpm.4.i = load %_IO_vtable*, %_IO_vtable** %vtpm.3.i, align 8
  %vtpm.5.i = getelementptr %_IO_vtable, %_IO_vtable* %vtpm.4.i, i64 0, i32 7
  %tmp.0.i = load %IO* (%IO*, %String*)*, %IO* (%IO*, %String*)** %vtpm.5.i, align 8
  %vtpm.6.i = tail call %IO* %tmp.0.i(%IO* nonnull %vtpm.1.i, %String* nonnull @String.1)
  %vtpm.7.i = bitcast %IO* %vtpm.6.i to %Object*
  ret %Object* %vtpm.7.i
...
entry:
  %vtpm.27 = tail call i8* @malloc(i32 16)
