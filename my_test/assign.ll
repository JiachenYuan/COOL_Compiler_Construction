...
@global_str.0 = internal constant [10 x i8] c"assign.cl\00"
...
entry:
	...
	%vtpm.5 = load %Object*, %Object** %vtpm.4
	%vtpm.6 = call %Int* @Int_new(  )
	call void(%Int*, i32 ) @Int_init( %Int* %vtpm.6, i32 1 )
	%vtpm.8 = bitcast %Int* %vtpm.6 to %Object*
	store %Object* %vtpm.8, %Object** %vtpm.4
	%vtpm.9 = call %Int* @Int_new(  )
	call void(%Int*, i32 ) @Int_init( %Int* %vtpm.9, i32 1 )
	%vtpm.11 = bitcast %Int* %vtpm.9 to %Object*
	store %Object* %vtpm.11, %Object** %vtpm.1
	%vtpm.12 = load %Object*, %Object** %vtpm.1
	ret i1 true
