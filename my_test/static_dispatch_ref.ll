...
ok.0:
	...
	%tmp.9 = load %B* (%B*,%A*,i32) *, %B* (%B*,%A*,i32) ** %tmp.8
	%tmp.10 = bitcast %Main* %tmp.6 to %B*
	%tmp.11 = bitcast %B* %tmp.5 to %A*
	%tmp.12 = call %B*(%B*, %A*, i32 ) %tmp.9( %B* %tmp.10, %A* %tmp.11, i32 3 )
	%tmp.13 = bitcast %B* %tmp.12 to %Main*
	ret %String* @String.1
...
entry:
	%tmp.14 = alloca %Main*
	%tmp.15 = getelementptr %_Main_vtable, %_Main_vtable* @_Main_vtable_prototype, i32 0, i32 1
	%tmp.16 = load i32, i32* %tmp.15
	%tmp.17 = call i8*(i32 ) @malloc( i32 %tmp.16 )
	%tmp.18 = bitcast i8* %tmp.17 to %Main*
	%malloc.null = icmp eq %Main* %tmp.18, null
	br i1 %malloc.null, label %abort, label %okay

okay:
	%tmp.19 = getelementptr %Main, %Main* %tmp.18, i32 0, i32 0
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %tmp.19
	store %Main* %tmp.18, %Main** %tmp.14
	%tmp.20 = getelementptr %Main, %Main* %tmp.18, i32 0, i32 1
	%tmp.21 = call %String* @String_new(  )
	store %String* %tmp.21, %String** %tmp.20
	%tmp.22 = getelementptr %Main, %Main* %tmp.18, i32 0, i32 2
	store i1 false, i1* %tmp.22
	%tmp.23 = getelementptr %Main, %Main* %tmp.18, i32 0, i32 3
	store %B* null, %B** %tmp.23
	%tmp.24 = getelementptr %Main, %Main* %tmp.18, i32 0, i32 1
	%tmp.25 = call %String* @String_new(  )
	store %String* %tmp.25, %String** %tmp.24
	%tmp.26 = getelementptr %Main, %Main* %tmp.18, i32 0, i32 2
	store i1 false, i1* %tmp.26
	%tmp.27 = getelementptr %Main, %Main* %tmp.18, i32 0, i32 3
	store %B* null, %B** %tmp.27
	ret %Main* %tmp.18
